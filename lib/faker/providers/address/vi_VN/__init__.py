...
class Provider(AddressProvider):
    ...
    city_formats = (
        "{{city_prefix}} {{last_name}} {{middle_name}} {{first_name_male}}",
        "{{city_suffix}} {{last_name}} {{middle_name}} {{first_name_female}}",
        "{{city_suffix}} {{last_name}} {{middle_name}} {{first_name_unisex}}",
        "{{city_prefix}} {{last_name}} {{first_name_male}}",
        "{{city_suffix}} {{last_name}} {{first_name_female}}",
        "{{city_suffix}} {{last_name}} {{first_name_unisex}}",
    )

    street_name_formats = (
        "{{street_suffix}} {{last_name}} {{middle_name}} {{first_name_male}}",
        "{{street_suffix}} {{last_name}} {{middle_name}} {{first_name_female}}",
        "{{street_suffix}} {{last_name}} {{middle_name}} {{first_name_unisex}}",
        "{{street_suffix}} {{last_name}} {{first_name_male}}",
        "{{street_suffix}} {{last_name}} {{first_name_female}}",
        "{{street_suffix}} {{last_name}} {{first_name_unisex}}",
    )
